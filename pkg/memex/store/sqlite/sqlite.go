...
// Store implements store.SQLStore backed by SQLite.
type Store struct {
	db         *sql.DB
...
func (s *Store) Exec(ctx context.Context, query string, args ...any) (store.Result, error) {
	return s.db.ExecContext(ctx, query, args...)
}

// QueryRow executes a query that returns at most one row.
func (s *Store) QueryRow(ctx context.Context, query string, args ...any) store.Row {
...
func (s *Store) Tx(ctx context.Context, fn func(tx store.SQLStore) error) error {
...
// txStore wraps a sql.Tx to implement store.SQLStore.
type txStore struct {
	tx *sql.Tx
}

func (t *txStore) Exec(ctx context.Context, query string, args ...any) (store.Result, error) {
	return t.tx.ExecContext(ctx, query, args...)
}

func (t *txStore) QueryRow(ctx context.Context, query string, args ...any) store.Row {
	return t.tx.QueryRowContext(ctx, query, args...)
}

func (t *txStore) Query(ctx context.Context, query string, args ...any) (store.Rows, error) {
...
func (t *txStore) Tx(_ context.Context, fn func(tx store.SQLStore) error) error {
