// Package store defines interfaces for the memex persistence layer.
//
// The store system uses four complementary backends:
...
//
// store has no semantic awareness of "memory" or "notes"; it is a general-purpose
// persistence library that other memex subpackages (and ycode subsystems such as
// sessions, MCP, config cache, permissions) build on top of.
package store
