...
// dupPipeFd is not supported on non-unix platforms.
// Pipelines will work but may not propagate EOF/SIGPIPE correctly.
func dupPipeFd(f *os.File) (*os.File, error) {
	return f, nil // no-op: return the same file
}
