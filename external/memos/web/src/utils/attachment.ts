...
export const getAttachmentUrl = (attachment: Attachment) => {
  ...
  return `${window.location.origin}${basePath}/file/${attachment.name}/${attachment.filename}`;
};

export const getAttachmentThumbnailUrl = (attachment: Attachment) => {
  return `${window.location.origin}${basePath}/file/${attachment.name}/${attachment.filename}?thumbnail=true`;
};

export const getAttachmentMotionClipUrl = (attachment: Attachment) => {
  return `${window.location.origin}${basePath}/file/${attachment.name}/${attachment.filename}?motion=true`;
};
