module example/oci-version

go 1.26.2

require github.com/qiangli/ycode/pkg/oci v0.0.0
...
// For local development, point to the local pkg/oci module.
replace github.com/qiangli/ycode/pkg/oci => ../../pkg/oci

// Required: the podman fork replace directive.
// Copy this into your own go.mod when importing pkg/oci.
replace go.podman.io/podman/v6 => github.com/qiangli/podman/v6 v6.0.0-20260426160603-961aacd7a726
