...
// implements RichHandler, so structured content blocks (e.g. an image
// result) survive the composite hop. Otherwise wraps the legacy string
// output in a single text block.
